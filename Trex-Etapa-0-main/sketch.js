...
function setup() {
  ...
  life=createSprite(80,80,54,17);
  life.scale=1.25
  life.addAnimation("3H",threeHeartsImg);
  life.addAnimation("1H",oneHeartImg);
  life.addAnimation("0H",noHeartsImg);
  life.changeAnimation("3H");
...
function loseHeart() {
  if(AlienG[0].x<0){
    life=life-1
    life.addAnimation("2H",twoHeartsImg);
  }
}